...
export const CHURCH = {
  ...
  logoInitials: 'MR',
  tagline: 'Iglesia cristiana en Talca — Una familia en Cristo, una esperanza para el mundo',
  heroQuote: '"Porque donde están dos o tres congregados en mi nombre, allí estoy yo en medio de ellos." — Mateo 18:20',
  pastor: {
    name: 'Luis Valdes',
  ...
  mapsLink: 'https://www.google.com/maps/search/?api=1&query=G8XQ%2BHX+Talca,+Chile',
