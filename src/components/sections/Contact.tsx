...
import { MapPin, Clock, Mail, Send, Phone, Navigation } from 'lucide-react'
  ...
  return (
    <section id="contacto" className="py-20 md:py-28 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <SectionHeader title="Contacto y Ubicación" subtitle="Visítanos, escríbenos o síguenos en redes." />
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <GlassCard>
              <h3 className="font-display text-xl font-semibold text-deep-blue dark:text-white mb-4 flex items-center gap-2">
                <MapPin className="text-gold-soft" size={22} /> Dirección
              </h3>
              <p className="text-deep-navy/80 dark:text-white/75 mb-2">{CHURCH.address}</p>
            ...
            <GlassCard>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-deep-navy/80 dark:text-white/75 hover:text-gold-soft transition-colors"
              >
                {CHURCH.phone}
              </a>
            </GlassCard>
            ...
            <GlassCard>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-deep-blue dark:text-white"
                />
                <input
                  type="email"
                  required
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-deep-blue dark:text-white resize-none"
                />
                {status === 'ok' && <p className="text-green-600 text-sm">Mensaje enviado. ¡Gracias!</p>}
                {status === 'error' && <p className="text-red-500 text-sm">Error al enviar. Intenta de nuevo.</p>}
